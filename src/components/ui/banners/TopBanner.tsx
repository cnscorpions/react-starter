            ...
            <div className="w-full lg:w-auto lg:justify-end flex items-center space-x-3">
              <div className="flex-grow">
                ...
                <div className="hidden sm:flex font-extrabold items-center space-x-1">
                  ...
                  <div className="w-16 text-center border border-transparent rounded-md px-1 py-1 font-extrabold shadow-md focus:outline-none focus:ring-2 focus:ring-slate-500 text-blue-800 bg-blue-100 border-blue-100 select-none">
                    React
                  </div>
                  <a
